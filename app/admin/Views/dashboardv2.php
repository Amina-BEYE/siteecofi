...
<div class="card">
    <div class="card-header">
        ...
        <a href="adminPage.php?page=orders" class="btn">Voir toutes</a>
    </div>
    <div class="table-container">
        <table>
            <thead>
            ...
            <tbody>
                <?php if (!empty($commandes)): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="adminPage.php?page=orders&action=view&id=<?= $cmd['id'] ?>" class="btn-small">
...
<div class="row">
    <div class="card">
        <div class="card-header">
            ...
            <a href="adminPage.php?page=products" class="btn-small">Gérer</a>
        </div>
        <div class="table-container">
            <table>
                <thead>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="adminPage.php?page=clients" class="btn-small">Voir tous</a>
        </div>
        <div class="table-container">
            <table>
                <thead>
