...
class SettingsModel
{
    ...
    private array $defaultSettings = [
        ...
        ['mail', 'smtp_user', 'Utilisateur SMTP', '', 'text'],
        ['mail', 'smtp_password', 'Mot de passe SMTP', '', 'password'],
        ['mail', 'smtp_encryption', 'Sécurité SMTP', 'tls', 'text'],
        ['mail', 'imap_host', 'Serveur IMAP réception', '', 'text'],
        ['mail', 'imap_port', 'Port IMAP', '993', 'number'],
        ['mail', 'imap_flags', 'Options IMAP', '/imap/ssl', 'text'],
        ['mail', 'imap_user', 'Utilisateur IMAP', '', 'text'],
